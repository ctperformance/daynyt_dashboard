...
export async function GET(request) {
  try {
    ...
    if (!insightsRes.ok) {
      ...
      const basicFields = ['adset_name', 'adset_id', 'campaign_name', 'campaign_id', 'spend', 'impressions', 'clicks', 'reach', 'inline_link_clicks', 'actions', 'action_values', 'cpc', 'cpm', 'ctr', 'frequency'].join(',');
