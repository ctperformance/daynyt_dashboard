  ...
  try {
    ...
    if (!insightsRes.ok) {
      ...
      if (authResult.retry && authResult.new_token) {
        ...
        const retryUrl = `https://graph.facebook.com/v21.0/${adAccountId}/insights?fields=${fields}&time_range=${timeRange}&level=adset&filtering=${encodeURIComponent(filtering)}&limit=100&access_token=${access_token}`;
